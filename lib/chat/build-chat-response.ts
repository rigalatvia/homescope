...
const KNOWLEDGE_BASE: ChatKnowledgeArticle[] = [
  ...
  },
  {
    ...
    answer: [
      "For first-time buyers in Ontario, the usual path is financial readiness, mortgage pre-approval, agent selection, listing search, offer strategy, inspection and financing, and closing.",
