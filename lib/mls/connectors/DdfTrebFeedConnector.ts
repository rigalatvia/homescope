...
export class DdfTrebFeedConnector implements MLSFeedConnector {
  ...
  private mapDdfRecordToRawListing(record: JsonObject, index: number): RawMLSFeedListing {
    ...
    return {
      ...
      propertyClass: pickString(record, ["PropertyClass", "Class", "PropertyType"]),
      transactionType: pickString(record, ["TransactionType", "ForSaleOrRent", "LeaseType"]),
      ...
      propertyType: pickString(record, ["PropertyType", "Type"]),
